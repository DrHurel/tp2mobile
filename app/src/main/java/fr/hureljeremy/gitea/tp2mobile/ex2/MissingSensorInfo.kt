package fr.hureljeremy.gitea.tp2mobile.ex2
...
class MissingSensorInfo : AppCompatActivity() {
    ...
    private fun displaySensorInfo(sensor: String) {
...
sensorContainer.addView(sensorInfoView)
    ...
    private val sensorConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName, service: IBinder) {
            ...
            val unavailableSensors = sensorService.getUnavailableSensors()
            if (unavailableSensors.isEmpty()) {
                displaySensorInfo("No missing sensors")
                return
            }
